...
public class ActivityRegisterBindingImpl extends ActivityRegisterBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.register_textView, 1);
        sViewsWithIds.put(R.id.reg_pwd, 2);
        sViewsWithIds.put(R.id.reg_email, 3);
        sViewsWithIds.put(R.id.btn_register, 4);
        sViewsWithIds.put(R.id.registerProgressBar, 5);
        sViewsWithIds.put(R.id.btn_fb, 6);
        sViewsWithIds.put(R.id.btn_google, 7);
    }
    // views
    @NonNull
